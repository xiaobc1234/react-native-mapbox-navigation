...
react-native-mapbox-navigation库我拉取时还是通过cocoapod安装的mapbox，但mapbox v3不支持cocoapod，所以该库目前只能使用v2的版本。
突然有天发现了 expo-mapbox-navigation 库已经包含我需要的所有功能，所以直接切换到expo-mapbox-navigation
